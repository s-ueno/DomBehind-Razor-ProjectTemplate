namespace DomBehind.RazorTemplate.ContentsHoge {
    export class MainViewModel extends DomBehind.BizViewModel {
        ...
        public FindCustomerAsync() {
            ...
            var svc = new FindCustomerWebProxy();
        ...
        public OnSelectedRow(e) {
            let row: Customer = e;
            if (row) {
                this.NotifyEvent(Mediator.SelectedCustomerEvent, row);
            }
        }
        ...
        public OnEdit(row: Customer) {
            this.OnSelectedRow(row);
            this.ShowDetailContent();
        }
        public OnDeleted(row: Customer) {

        }
        public OnSave(row: Customer) {
